...
import { ShieldCheck, BadgeDollarSign, MapPinned, MousePointerClick } from 'lucide-react';

const ExtraSections = () => {
    return (
        <section className="bg-[#FFF8E7] py-20 lg:py-28 px-4">
                ...
                <div className="mt-28">
                    ...
                    <div className="flex items-center justify-between mb-10 flex-col sm:flex-row gap-4">
                        <div>
                            ...
                            <p className="text-[#6B7280] mt-3">
                                Popular Qurbani breeds available this season
                            </p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8">
                        ...
                        <div className="card bg-white shadow-sm overflow-hidden">
                            <figure className="h-60 bg-[#E8F5E9] text-8xl flex items-center justify-center">
                                🐂
                            </figure>
                            ...
                            <div className="card-body">
                                ...
                                <p className="text-[#6B7280] leading-7">
                                    Known for strong health and premium meat quality.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="card bg-white shadow-sm overflow-hidden">
                            ...
                            <div className="card-body">
                                ...
                                <p className="text-[#6B7280] leading-7">
                                    Popular South Asian breed with excellent body structure.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="card bg-white shadow-sm overflow-hidden">
                            ...
                            <div className="card-body">
                                ...
                                <p className="text-[#6B7280] leading-7">
                                    Highly demanded local goat breed across Bangladesh.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="card bg-white shadow-sm overflow-hidden">
                            ...
                            <div className="card-body">
                                ...
                                <p className="text-[#6B7280] leading-7">
                                    Traditional local breed trusted for Qurbani every year.
                                </p>
                            </div>
                        </div>
