        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300 leading-6 mb-5">
              Follow our social platforms to get updates about featured
              livestock and Qurbani offers.
            </p>
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-yellow-400 hover:text-black duration-300"
              >
                <FaFacebookF />
              </a>
